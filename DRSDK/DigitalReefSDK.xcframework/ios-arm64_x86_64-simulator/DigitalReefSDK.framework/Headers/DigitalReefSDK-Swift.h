...
@property (nonatomic, copy) void (^ _Nullable viewWasLoaded)(void);
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC14DigitalReefSDK13DRInAppHelper")
...
@class NSDictionary;
SWIFT_CLASS("_TtC14DigitalReefSDK12DRInAppModel")
@interface DRInAppModel : NSObject
@property (nonatomic, copy) NSString * _Nonnull type;
@property (nonatomic, copy) NSString * _Nonnull backgroundURL;
@property (nonatomic, copy) NSString * _Nonnull backgroundColor;
@property (nonatomic, copy) NSString * _Nonnull themeColor;
@property (nonatomic, copy) NSString * _Nonnull closeButtonPosition;
@property (nonatomic, copy) NSString * _Nonnull adId;
@property (nonatomic, copy) NSString * _Nonnull campaignId;
@property (nonatomic, copy) NSString * _Nonnull ctaActionType;
@property (nonatomic, copy) NSArray<NSDictionary *> * _Nonnull inAppContent;
...
SWIFT_ENUM_FWD_DECL(NSInteger, OTAEvent)
@class UIApplication;
@class NSData;
...
- (void)saveMessage:(DRInAppHelper * _Nonnull)item completion:(void (^ _Nullable)(void))completion;
...
- (void)updateAdShown:(NSString * _Nonnull)id completion:(void (^ _Nullable)(void))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface UIColor (SWIFT_EXTENSION(DigitalReefSDK))
- (nullable instancetype)initWithHex_ARGB:(NSString * _Nonnull)hex_ARGB;
- (nullable instancetype)initWithHex_RGBA:(NSString * _Nonnull)hex_RGBA;
@end
